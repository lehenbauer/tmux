...
new_scene 40 12
$TMUX2 new-pane -x22 -y8 -X7 -Y2 "sh -c 'printf FLOAT; exec sleep 100'" || exit 1
...
new_scene 40 12
$TMUX2 new-pane -x22 -y8 -X29 -Y7 "sh -c 'printf CLIP; exec sleep 100'" || exit 1
...
new_scene 28 8
$TMUX2 new-pane -x18 -y7 -X17 -Y3 "sh -c 'printf OUT; exec sleep 100'" || exit 1
compare floating-outside

# Floating pane clipped at the top-left corner (negative offsets).
new_scene 40 12
$TMUX2 new-pane -x20 -y8 -X-5 -Y-3 "sh -c 'printf TL; exec sleep 100'" || exit 1
...
new_scene 40 12
fill_base_pattern
$TMUX2 new-pane -x22 -y8 -X-11 -Y2 "sh -c 'printf LEFT; exec sleep 100'" || exit 1
compare floating-clip-left

new_scene 40 12
fill_base_pattern
$TMUX2 new-pane -x22 -y8 -X29 -Y2 "sh -c 'printf RIGHT; exec sleep 100'" || exit 1
compare floating-clip-right

new_scene 40 12
fill_base_pattern
$TMUX2 new-pane -x22 -y8 -X9 -Y-4 "sh -c 'printf TOP; exec sleep 100'" || exit 1
compare floating-clip-top

new_scene 40 12
fill_base_pattern
$TMUX2 new-pane -x22 -y8 -X9 -Y8 "sh -c 'printf BOTTOM; exec sleep 100'" || exit 1
...
tile_2x2
fill_all_panes
$TMUX2 new-pane -x18 -y8 -X10 -Y2 "sh -c 'printf FLT; exec sleep 100'" || exit 1
...
tile_2x2
fill_all_panes
$TMUX2 new-pane -x18 -y8 -X10 -Y2 -B double \
...
new_scene 40 12
$TMUX2 new-pane -x18 -y8 -X3 -Y1 "sh -c 'printf AAA; exec sleep 100'" || exit 1
$TMUX2 new-pane -x18 -y8 -X13 -Y5 "sh -c 'printf BBB; exec sleep 100'" || exit 1
...
$TMUX2 new-pane -x18 -y6 -X2 -Y0 -T one \
...
$TMUX2 new-pane -x18 -y6 -X17 -Y5 -T two \
...
$TMUX2 new-pane -x18 -y8 -X21 -Y2 "sh -c 'printf OVERSB; exec sleep 100'" || exit 1
...
$TMUX2 new-pane -x22 -y8 -X7 -Y6 "sh -c 'printf OVERST; exec sleep 100'" || exit 1
